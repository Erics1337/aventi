...
export default function FavoritesScreen() {
  ...
  const identityMode = auth.isFullAccount ? 'Account' : auth.isAnonymousUser ? 'Guest (Anonymous)' : 'Not Signed In';
      ...
      <View className="flex-1 bg-black px-4 pt-14">
        ...
        <GlassPanel>
          ...
          <Text className="mt-2 text-sm leading-5 text-white/70">
            Favorites persistence needs a Supabase guest session or a full account.
          </Text>
            ...
            <Text className="mt-1 text-xs leading-5 text-white/65">
              {auth.isAnonymousUser
                ...
                : auth.isFullAccount
                  ...
                  : auth.guestAuthError ?? 'Favorites need a Supabase guest session or account.'}
            </Text>
          </View>
